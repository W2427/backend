 ...
 * 主图纸
 */
public class CalendarRepositoryImpl extends BaseRepository implements CalendarRepositoryCustom {
...
//        sql.append("d.budget_man_hour as budgetManHour, ");
//        sql.append("d.doc_type as docType, ");
//        sql.append("d.yinson_doc_no as yinsonDocNo, ");
...
//        sql.append("d.stage as stage, ");
//        sql.append("d.stage_id as stageId, ");
//        sql.append("d.process as process, ");
//        sql.append("d.process_id as processId, ");
//        sql.append("d.version as version, ");
//        sql.append("d.drawing_status as drawingStatus, ");
//        sql.append("dh.vp AS vp, ");
//        sql.append("dh.sh AS sh, ");
//        sql.append("dh.lead_engineer AS leadEngineer, ");
//        sql.append("dh.engineer AS engineer, ");
//        sql.append("dh.work_hour AS workHour ");
//
//
//        sql.append("FROM drawing AS d ");
//
//
//        sql.append("left join bpm_entity_sub_type AS c ON d.`drawing_category_id` = c.`id` ");
//        sql.append("LEFT JOIN drawing_history AS dh ON dh.drawing_id = d.id ");
...
//            whereSql.append("AND (d.yinson_doc_no like :yinsonDocNo or d.document_title like :documentTitle)");
//        }
//
...
//
//        if (criteriaDTO.getKeyword() != null) {
//            query.setParameter("yinsonDocNo", "%" + criteriaDTO.getKeyword() + "%");
//            countQuery.setParameter("yinsonDocNo", "%" + criteriaDTO.getKeyword() + "%");
...
////            dwg.setDrawingStatus(DrawingStatus.valueOf(wpsMap.get("drawing_status") == null ? "" : wpsMap.get("drawing_status").toString()));
...
//                }
//            }
//            BeanUtils.copyProperties(wpsMap, dwg, "status", "drawingStatus");
//            dwgList.add(dwg);
//        }
//
//
