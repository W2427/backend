...
//        String accessToken = "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiIxNjIzNTUxMDEwMzE5NDg1Mjk1XG4xNTMzMDIzMjc1NDkyMTUwMDk3XG5hZG1pbmlzdHJhdG9yXG5cbuWGr-mTgemqpVxuazJ5bG82cXdcbjdGMDAwMDAxXG4xNTk2OTg3OTg0MDIwNzUzMjA5In0.mK0keBbotv1xSlk_icMNOmVBs1ShPVHre7txo07Q1wKlyRUs5fWJWQ_ssTZChZs_";
//        String tokenKey = "M83mf1izxobTGOAvtmQpcQVljRF10fPkx0q6UpDTLCjegHsJ3ufeKEhQIzSGwLkK";
//        String userAgent = "PostmanRun";
//        Jwts
//            .parser()
//            .setSigningKey(
//                tokenKey
...
//            .parseClaimsJws(accessToken);
        ...
        String t1 = "sub_system sub_system_description priority completion_leader module blm_no w3_look_ahead cstr_rfcc_plan_date cstr_rfcc_baseline walkdown_date rfcc_mrfcc_erfcc_signed total remain complete_percent punch_a punch_b punch_c total1 const_mgr comm_mgr worksite_mgr const_mgr1 comm_mgr1 worksite_mgr1 comments issue_due_to rfi_raised_date mrfc ncr overdue overdue_reason overdue_due_to";
        String t2 = underscoreToCamelCase(t1);
    ...
    public static String upperFirst(String name) {
        //substring
        char[] chars = name.toCharArray();
        if(CharUtil.isLetterLower(chars[0]))
            chars[0] -= 32;
        return String.valueOf(chars);
    }
    ...
    public static boolean checkMobile(String in) {
        Pattern pattern = Pattern.compile("^[1\\+]\\d{6,10}$");
        return pattern.matcher(in).matches();
    }

    public static String join(Object[] array, String comma) {
        return String.join(comma, Arrays.stream(array)
                .map(Object::toString)
                .toArray(String[]::new));
    }
}
