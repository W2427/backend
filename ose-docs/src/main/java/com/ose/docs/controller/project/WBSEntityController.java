...
import com.ose.docs.api.project.WBSEntityAPI;
...
@Tag(name = "WBS 实体导入文件接口")
@RestController
public class WBSEntityController extends BaseController implements WBSEntityAPI {

    // 项目层级结构导入文件查询服务
    private final DocumentInterface<WBSEntitiesES> wbsEntityService;

    /**
     * 构造方法。
     *
     * @param wbsEntityService 项目实体导入文件查询服务
     */
    @Autowired
    public WBSEntityController(
        DocumentInterface<WBSEntitiesES> wbsEntityService
    ) {
        this.wbsEntityService = wbsEntityService;
    }

    @Override
    @Operation(description = "取得 WBS 实体导入文件")
    @RequestMapping(
        method = GET,
    ...
    @SetUserInfo
    public JsonObjectResponseBody<WBSEntitiesES> get(
        ...
        return new JsonObjectResponseBody<>(
            wbsEntityService.get(orgId, projectId, fileId)
        );
    }

    @Override
    @Operation(description = "查询 WBS 实体导入文件")
    @RequestMapping(
        method = GET,
    ...
    @WithPrivilege // TODO
    @SetUserInfo
    public JsonListResponseBody<WBSEntitiesES> list(
        @PathVariable @Parameter(description = "所属组织 ID") String orgId,
    ...
    public JsonListResponseBody<WBSEntitiesES> list(
        ...
        return new JsonListResponseBody<>(
            wbsEntityService.list(orgId, projectId, pageDTO.toPageable())
        );
    }
