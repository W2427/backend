 ...
 * 入库单文件数据仓库。
 */
public class MmReleaseReceiveFileCustomImpl extends BaseRepository implements MmReleaseReceiveFileCustom {
     ...
     * @param releaseReceiveId   入库单文件 ID
    ...
    public Page<MmReleaseReceiveFileEntity> search(
        ...
        return getSQLQueryBuilder(MmReleaseReceiveFileEntity.class)
            .is("orgId", orgId)
            .is("projectId", projectId)
            .is("releaseReceiveId", releaseReceiveId)
