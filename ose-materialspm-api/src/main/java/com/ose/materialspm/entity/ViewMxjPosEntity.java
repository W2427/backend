 ...
 */
@Entity
@Table(name = "v_mxj_POS")
@NamedQuery(name = "ViewMxjPosEntity.findAll", query = "SELECT a FROM ViewMxjPosEntity a")
public class ViewMxjPosEntity extends BaseDTO {
