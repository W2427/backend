...
/**
 * Spm M_LIST_POS 缓存表 SpmListPosSqlResultMapping
 */
@SqlResultSetMapping
    (
        name = "SpmListPosSqlResultMapping",
        entities = {
            @EntityResult(
                entityClass = SpmListPosDTO.class, //就是当前这个类的名字
                fields = {
                    @FieldResult(name = "lp_id", column = "lp_id"),
                    @FieldResult(name = "ln_id", column = "ln_id"),
                    @FieldResult(name = "dp_id", column = "dp_id"),
                    @FieldResult(name = "proj_id", column = "proj_id"),
                    @FieldResult(name = "lp_pos", column = "lp_pos"),
                    @FieldResult(name = "quantity", column = "quantity"),
                    @FieldResult(name = "lmod", column = "lmod"),
                    @FieldResult(name = "commodity_id", column = "commodity_id"),
                    @FieldResult(name = "ident", column = "ident"),
                    @FieldResult(name = "resv_qty", column = "resv_qty"),
                    @FieldResult(name = "tag_number", column = "tag_number"),
                    @FieldResult(name = "issue_qty", column = "issue_qty"),
...
@Entity
public class SpmListPosDTO extends BaseDTO {
