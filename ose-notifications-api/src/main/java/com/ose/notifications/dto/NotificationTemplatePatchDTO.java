 ...
 * 通知信息模版更新数据传输对象。
 */
public class NotificationTemplatePatchDTO extends BaseDTO implements NotificationTemplateDTOInterface {

    private static final long serialVersionUID = 3316694366101643799L;
