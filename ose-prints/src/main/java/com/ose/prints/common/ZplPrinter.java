...
public class ZplPrinter {
    ...
    private String darkness = "~SD30"; // Set Darkness设置色带颜色的深度 0-30
     ...
     */
    public ZplPrinter(String printerURI, String libPath) throws Exception {
        ...
        if (file.exists()) {
            ...
            System.out.println(libPath + "文件不存在");
            throw new Exception(libPath + "文件不存在");
        }
        // 初始化打印机
        ...
        if (printService == null) {
            ...
            throw new Exception("没有找到打印机：[" + printerURI + "]");
        } else {
     ...
     * @param y   y坐标
     */
    public void setQRcodeImage(BufferedImage image, int x, int y) {
        String str = Fnthex.printImage(image, x, y);// 条码内容
        content += str;
    }
