...
@FeignClient(name = "ose-report", contextId = "applyInspFeign")
public interface ApplicationForInspectionAPI {

    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/application-for-inspection"
    )
    JsonObjectResponseBody<ReportHistory> generateApplicationForInspection(
