...
@FeignClient(name = "ose-report", contextId = "ptReportFeign")
public interface PenetrationInspectionReportAPI {

    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/penetration-inspection-reports"
    )
    JsonObjectResponseBody<ReportHistory> generatePenetrationInspectionReport(
