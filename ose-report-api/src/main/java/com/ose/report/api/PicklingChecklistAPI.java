...
@FeignClient(name = "ose-report", contextId = "picklingChecklistFeign")
public interface PicklingChecklistAPI {

    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/pickling-checklists"
    )
    JsonObjectResponseBody<ReportHistory> generatePicklingChecklist(
