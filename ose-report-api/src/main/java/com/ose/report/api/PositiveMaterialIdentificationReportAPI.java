...
@FeignClient(name = "ose-report", contextId = "pmiReportFeign")
public interface PositiveMaterialIdentificationReportAPI {

    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/positive-material-identification-reports"
    )
    JsonObjectResponseBody<ReportHistory> generateMaterialPositiveIdentificationReport(
