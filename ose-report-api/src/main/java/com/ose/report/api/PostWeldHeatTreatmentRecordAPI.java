...
@FeignClient(name = "ose-report", contextId = "pwhtReportFeign")
public interface PostWeldHeatTreatmentRecordAPI {

    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/post-weld-heat-treatment-records"
    )
    JsonObjectResponseBody<ReportHistory> generatePostWeldHeatTreatmentRecord(
