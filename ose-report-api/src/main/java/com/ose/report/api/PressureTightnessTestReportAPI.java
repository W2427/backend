...
@FeignClient(name = "ose-report", contextId = "pressureTestReportFeign")
public interface PressureTightnessTestReportAPI {

    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/pressure-tightness-test-reports"
    )
    JsonObjectResponseBody<ReportHistory> generatePressureTightnessTestReport(
