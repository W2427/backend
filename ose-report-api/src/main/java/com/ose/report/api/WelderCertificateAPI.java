...
@FeignClient(name = "ose-report", contextId = "welderCertFeign")
public interface WelderCertificateAPI {

    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/welder-certificates"
    )
    JsonObjectResponseBody<ReportHistory> generateWelderCertificate(
