...
public class StructureMagneticParticleInspectionReportDTO extends BaseListReportDTO {

    private static final long serialVersionUID = -9004835885146754052L;
    ...
    private List<StructureMagneticParticleInspectionReportItemDTO> items;
    ...
    @Override
    public List<StructureMagneticParticleInspectionReportItemDTO> getItems() {
        return items;
    }

    public void setItems(List<StructureMagneticParticleInspectionReportItemDTO> items) {
        this.items = items;
    }
