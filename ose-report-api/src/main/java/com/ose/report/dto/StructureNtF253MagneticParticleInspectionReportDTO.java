...
public class StructureNtF253MagneticParticleInspectionReportDTO extends BaseListReportDTO {

    private static final long serialVersionUID = -5126187290904104881L;
    ...
    private List<StructureNtF253MagneticParticleInspectionReportItemDTO> items;
    ...
    @Override
    public List<StructureNtF253MagneticParticleInspectionReportItemDTO> getItems() {
        return items;
    }

    public void setItems(List<StructureNtF253MagneticParticleInspectionReportItemDTO> items) {
        this.items = items;
    }
