...
public class StructureNtF253UltrasonicTestInspectionReportDTO extends BaseListReportDTO {

    private static final long serialVersionUID = 8903340470423805654L;
    ...
    private List<StructureNtF253UltrasonicTestInspectionReportItemDTO> items;
    ...
    @Override
    public List<StructureNtF253UltrasonicTestInspectionReportItemDTO> getItems() {
        return items;
    }

    public void setItems(List<StructureNtF253UltrasonicTestInspectionReportItemDTO> items) {
        this.items = items;
    }
