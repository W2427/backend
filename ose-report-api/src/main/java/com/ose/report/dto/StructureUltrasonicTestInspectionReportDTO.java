...
public class StructureUltrasonicTestInspectionReportDTO extends BaseListReportDTO {

    private static final long serialVersionUID = -2273486173926928672L;
    ...
    private List<StructureUltrasonicTestInspectionReportItemDTO> items;
    ...
    @Override
    public List<StructureUltrasonicTestInspectionReportItemDTO> getItems() {
        return items;
    }

    public void setItems(List<StructureUltrasonicTestInspectionReportItemDTO> items) {
        this.items = items;
    }
