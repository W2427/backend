...
public class DivisionStatisticsArchiveData extends ArchiveDataBase {

    private static final long serialVersionUID = 6832193122190255052L;
    ...
    public DivisionStatisticsArchiveData() {
    }
    ...
    public DivisionStatisticsArchiveData(
        ...
        setDivision(StringUtils.isEmpty(division) ? null : division);
