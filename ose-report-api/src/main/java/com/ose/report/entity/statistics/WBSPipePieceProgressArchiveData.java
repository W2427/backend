...
public class WBSPipePieceProgressArchiveData extends ArchiveDataBase {

    private static final long serialVersionUID = 2750253530578323934L;

    @Override
    @Schema(description = "未完成长度")
    @JsonProperty("lengthUnfinished")
    public Double getValue01() {
        return super.getValue01();
    }

    @Override
    @Schema(description = "进行中长度")
    @JsonProperty("lengthInProcess")
    public Double getValue02() {
        return super.getValue02();
    }

    @Override
    @Schema(description = "已完成长度")
    @JsonProperty("lengthFinished")
