...
import com.ose.report.api.F217xStructurex07xStructureFitupInspectionReportAPI;
...
@Tag(name = "结构装配接口")
@RestController
public class F217xStructurex07xStructureFitupInspectionReportController extends BaseReportController implements F217xStructurex07xStructureFitupInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public F217xStructurex07xStructureFitupInspectionReportController(ReportHistoryInterface reportHistoryService,
    ...
    public JsonObjectResponseBody<ReportHistory> postStructureFitUpInspectionReport(
        @PathVariable @Parameter(description = "组织ID") Long orgId,
        @PathVariable @Parameter(description = "项目ID") Long projectId,
        @RequestBody @Parameter(description = "检查项内容") StructureFitupInspectionReportDTO reportPostDTO) {
        ...
        return new JsonObjectResponseBody<>(
            ...
            generateReportFile(
                ...
                orgId,
                projectId,
                "F217xStructurex07xStructureFitupInspectionReport.jasper",
                reportPostDTO));
    }
}
