...
import com.ose.report.api.F217xStructurex12xMagneticParticleTestReportAPI;
...
@Tag(name = "结构MT接口")
@RestController
public class F217xStructurex12xMagneticParticleTestReportController extends BaseReportController implements F217xStructurex12xMagneticParticleTestReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public F217xStructurex12xMagneticParticleTestReportController(ReportHistoryInterface reportHistoryService,
    ...
    public JsonObjectResponseBody<ReportHistory> postStructureMagneticParticleTestReport(
        @PathVariable @Parameter(description = "组织ID") Long orgId,
        @PathVariable @Parameter(description = "项目ID") Long projectId,
        @RequestBody @Parameter(description = "检查项内容") StructureMagneticParticleTestInspectionReportDTO reportPostDTO) {
        ...
        return new JsonObjectResponseBody<>(
            ...
            orgId,
            projectId,
            "F217xStructurex12xMagneticParticleTestReport.jasper",
            reportPostDTO));
    }
}
