...
import com.ose.report.api.F253xPipingPenetrantInspectionReportAPI;
...
@Tag(name = "结构PT接口")
@RestController
public class F253xPipingPenetrantInspectionReportController extends BaseReportController implements F253xPipingPenetrantInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public F253xPipingPenetrantInspectionReportController(ReportHistoryInterface reportHistoryService,
    ...
    public JsonObjectResponseBody<ReportHistory> postPipingNtF253PenetrantInspectionReport(
        @PathVariable @Parameter(description = "组织ID") Long orgId,
        @PathVariable @Parameter(description = "项目ID") Long projectId,
        @RequestBody @Parameter(description = "检查项内容") F253PipingPenetrantInspectionReportDTO reportPostDTO) {
        ...
        return new JsonObjectResponseBody<>(
            ...
            generateReportFile(
                ...
                orgId,
                projectId,
                "F253xPipingPenetrantInspectionReport.jasper",
                reportPostDTO));
    }
}
