...
import com.ose.report.api.F253xStructureMaterialInspectionReportAPI;
...
@Tag(name = "生成结构材料验收报告")
@RestController
public class F253xStructureMaterialInspectionReportController extends BaseReportController implements F253xStructureMaterialInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public F253xStructureMaterialInspectionReportController(
    ...
    @Operation(description = "生成结构材料验收报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateStructureMaterialInspectionReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "F253xStructureMaterialInspectionReport.jasper",
                reportDTO
            )
        );
    }
