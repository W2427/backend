...
import com.ose.report.api.FinalInspectionRecordForPipingPreFabricationAPI;
...
@Tag(name = "生成管道预制终检记录")
@RestController
public class FinalInspectionRecordForPipingPreFabricationController extends BaseReportController implements FinalInspectionRecordForPipingPreFabricationAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public FinalInspectionRecordForPipingPreFabricationController(
    ...
    @Operation(description = "生成管道预制终检记录")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateFinalInspectionRecordForPipingPreFabrication(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "final-inspection-record-for-piping-pre-fabrication.jasper",
                reportDTO
            )
        );
    }
