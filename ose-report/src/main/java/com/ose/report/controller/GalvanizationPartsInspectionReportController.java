...
import com.ose.report.api.GalvanizationPartsInspectionReportAPI;
...
@Tag(name = "生成镀锌件检查记录")
@RestController
public class GalvanizationPartsInspectionReportController extends BaseReportController implements GalvanizationPartsInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public GalvanizationPartsInspectionReportController(
    ...
    @Operation(description = "生成镀锌件检查记录")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateGalvanizationPartsInspectionReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "galvanization-parts-inspection-report.jasper",
                reportDTO
            )
        );
    }
