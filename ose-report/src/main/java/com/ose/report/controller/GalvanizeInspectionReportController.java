...
import com.ose.report.api.GalvanizeInspectionReportAPI;
...
@Tag(name = "生成镀锌检查记录")
@RestController
public class GalvanizeInspectionReportController extends BaseReportController implements GalvanizeInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public GalvanizeInspectionReportController(
    ...
    @Operation(description = "生成镀锌检查记录")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateGalvanizeInspectionReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "galvanize-inspection-report.jasper",
                reportDTO
            )
        );
    }
