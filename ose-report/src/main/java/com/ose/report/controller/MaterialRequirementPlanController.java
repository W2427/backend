...
import com.ose.report.api.MaterialRequirementPlanAPI;
...
@Tag(name = "生成用料计划")
@RestController
public class MaterialRequirementPlanController extends BaseReportController implements MaterialRequirementPlanAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public MaterialRequirementPlanController(
    ...
    @Operation(description = "生成用料计划")
    @RequestMapping(
        method = POST,
        value = "/orgs/{orgId}/projects/{projectId}/material-requirement-plans"
    )
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateMaterialRequirementPlan(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "material-requirement-plan.jasper",
                reportDTO
            )
        );
    }
