...
import com.ose.report.api.PipeFittingInspectionReportAPI;
...
@Tag(name = "生成管附件验收报告")
@RestController
public class PipeFittingInspectionReportController extends BaseReportController implements PipeFittingInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public PipeFittingInspectionReportController(
    ...
    @Operation(description = "生成管附件验收报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generatePipeFittingInspectionReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "F253xPipeFittingInspectionReport.jasper",
                reportDTO
            )
        );
    }
