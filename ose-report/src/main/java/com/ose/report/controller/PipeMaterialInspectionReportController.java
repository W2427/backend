...
import com.ose.report.api.PipeMaterialInspectionReportAPI;
...
@Tag(name = "生成管材料验收报告")
@RestController
public class PipeMaterialInspectionReportController extends BaseReportController implements PipeMaterialInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public PipeMaterialInspectionReportController(
    ...
    @Operation(description = "生成管材料验收报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generatePipeMaterialInspectionReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "F253xPipeMaterialInspectionReport.jasper",
                reportDTO
            )
        );
    }
