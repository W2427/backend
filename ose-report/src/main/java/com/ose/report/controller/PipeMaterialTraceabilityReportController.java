...
import com.ose.report.api.PipeMaterialTraceabilityReportAPI;
...
@Tag(name = "生成管材料跟踪报告")
@RestController
public class PipeMaterialTraceabilityReportController extends BaseReportController implements PipeMaterialTraceabilityReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public PipeMaterialTraceabilityReportController(
    ...
    @Operation(description = "生成管材料跟踪报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generatePipeMaterialTraceabilityReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "pipe-material-traceability-report.jasper",
                reportDTO
            )
        );
    }
