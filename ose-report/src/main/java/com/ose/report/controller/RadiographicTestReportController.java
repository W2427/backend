...
import com.ose.report.api.RadiographicTestReportAPI;
...
@Tag(name = "生成射线检验报告")
@RestController
public class RadiographicTestReportController extends BaseReportController implements RadiographicTestReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public RadiographicTestReportController(
    ...
    @Operation(description = "生成射线检验报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateRadiographicTestReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "radiographic-test-report.jasper",
                reportDTO
            )
        );
    }
