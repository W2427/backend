...
import com.ose.report.api.UltrasonicTestReportAPI;
...
@Tag(name = "生成超声波检验报告")
@RestController
public class UltrasonicTestReportController extends BaseReportController implements UltrasonicTestReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public UltrasonicTestReportController(
    ...
    @Operation(description = "生成超声波检验报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateUltrasonicTestReport(
