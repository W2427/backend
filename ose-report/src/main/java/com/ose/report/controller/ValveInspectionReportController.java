...
import com.ose.report.api.ValveInspectionReportAPI;
...
@Tag(name = "生成阀件验收报告")
@RestController
public class ValveInspectionReportController extends BaseReportController implements ValveInspectionReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public ValveInspectionReportController(
    ...
    @Operation(description = "生成阀件验收报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateValveInspectionReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "F253xPipeValvesInspectionReport.jasper",
                reportDTO
            )
        );
    }
