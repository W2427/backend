...
import com.ose.report.api.WeldHardnessTestReportAPI;
...
@Tag(name = "生成焊缝硬度测试报告")
@RestController
public class WeldHardnessTestReportController extends BaseReportController implements WeldHardnessTestReportAPI {

    /**
     * 构造方法。
     */
    @Autowired
    public WeldHardnessTestReportController(
    ...
    @Operation(description = "生成焊缝硬度测试报告")
    @RequestMapping(
        method = POST,
    ...
    @WithPrivilege
    @Override
    public JsonObjectResponseBody<ReportHistory> generateWeldHardnessTestReport(
        ...
        return new JsonObjectResponseBody<>(
            generateReportFile(
                ...
                orgId,
                projectId,
                "weld-hardness-test-report.jasper",
                reportDTO
            )
        );
    }
