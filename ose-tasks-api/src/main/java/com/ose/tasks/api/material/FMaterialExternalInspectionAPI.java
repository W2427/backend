...
public interface FMaterialExternalInspectionAPI {
    ...
    public JsonObjectResponseBody<FMaterialStocktakeItemEntity> postFEIP(
    ...
    public JsonResponseBody postFEIPs(
        @PathVariable @Parameter(description = "projectId") Long projectId,
        @PathVariable @Parameter(description = "orgId") Long orgId,
        @PathVariable @Parameter(description = "relnId") Long relnId,
    ...
    public JsonListResponseBody<FMaterialStocktakeItemEntity> getFEIPs(
        @PathVariable @Parameter(description = "projectId") Long projectId,
        @PathVariable @Parameter(description = "orgId") Long orgId,
        @PathVariable @Parameter(description = "relnId") Long relnId,
        PageDTO pageDTO);
    ...
    public JsonResponseBody deleteFEIP(
        @PathVariable @Parameter(description = "projectId") Long projectId,
        @PathVariable @Parameter(description = "orgId") Long orgId,
        @PathVariable @Parameter(description = "relnId") Long relnId,
    ...
    public JsonResponseBody saveFEIP(
        @PathVariable @Parameter(description = "projectId") Long projectId,
        @PathVariable @Parameter(description = "orgId") Long orgId,
        @PathVariable @Parameter(description = "relnId") Long relnId,
