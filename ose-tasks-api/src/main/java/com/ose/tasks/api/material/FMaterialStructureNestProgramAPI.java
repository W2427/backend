...
public interface FMaterialStructureNestProgramAPI {
    ...
    @WithPrivilege
    @ResponseStatus(OK)
    JsonListResponseBody<FMaterialStructureNestProgram> search(@PathVariable @Parameter(description = "orgId") Long orgId,
