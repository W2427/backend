 ...
 * 批处理执行结果。
 */
public class PerformanceBatchResultDTO extends BaseDTO {
     ...
     * 构造方法。
     */
    public PerformanceBatchResultDTO() {
    }

    /**
     * 构造方法。
     */
    public PerformanceBatchResultDTO(BatchTask batchTask) {
     ...
     * 累加数据处理件数。
     */
    public void sum(PerformanceBatchResultDTO result) {
    ...
    public PerformanceBatchResultDTO addLog(String message) {
        log.add(message);
        return this;
    }
