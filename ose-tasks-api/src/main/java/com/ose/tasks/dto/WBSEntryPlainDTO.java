...
public class WBSEntryPlainDTO extends BaseDTO {


    private static final long serialVersionUID = -3772246722205908656L;
    ...
    public WBSEntryPlainDTO() {
        super();
    }

    public WBSEntryPlainDTO(WBSEntry entry) {
        this();
