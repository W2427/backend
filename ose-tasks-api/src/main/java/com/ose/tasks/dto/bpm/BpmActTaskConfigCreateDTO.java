...
public class BpmActTaskConfigCreateDTO extends BaseDTO {


    private static final long serialVersionUID = -2239978763073156228L;
    //流程节点名称
    ...
    //任务类型
    @Schema(description = "任务类型，如EX_INSP_UPLOAD_REPORT")
