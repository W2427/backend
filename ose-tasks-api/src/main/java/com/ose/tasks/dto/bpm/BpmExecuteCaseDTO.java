...
public class BpmExecuteCaseDTO extends BaseDTO {

    private static final long serialVersionUID = -464105666237562928L;
    ...
    @Schema(description = "taskKey匹配规则")
    private String matchingFlag;

    @Schema(description = "taskKey匹配值")
    private String matchingKey;

    @Schema(description = "taskKey匹配字段")
