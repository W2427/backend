 ...
 * 材料准备单DTO
 */
public class FMaterialSurplusReceiptsCreateDTO extends BaseDTO {

    private static final long serialVersionUID = 7294508410317771637L;
    @Schema(description = "余料领料单号")
    private String no;

    @Schema(description = "余料领料单描述")
    private String desc;
