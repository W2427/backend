...
/**
 * Structure weld UPDATE 实体数据传输对象。 TODO
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class StructureWeldEntryUpdateDTO extends BaseDTO {


    private static final long serialVersionUID = 3531391625978090025L;
