...
public class Wp03EntryInsertDTO extends BaseDTO {


    private static final long serialVersionUID = 1562248188365965533L;
    ...
    public void setRemarks(String ramarks) {
        this.remarks = ramarks;
    }
