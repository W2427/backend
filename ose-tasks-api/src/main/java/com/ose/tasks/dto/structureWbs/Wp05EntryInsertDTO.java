...
public class Wp05EntryInsertDTO extends BaseDTO {
    ...
    @Schema(description = "总重单位")
    @Enumerated(EnumType.STRING)
    private WeightUnit totalWeightUnit;

    @Schema(description = "总重文本")
    ...
    public WeightUnit getTotalWeightUnit() {
        return totalWeightUnit;
    }

    public void setTotalWeightUnit(WeightUnit totalWeightUnit) {
