 ...
 */
@Entity
@Table(name = "bpm_act_task_assignee_history"
    ,
    indexes = {
...
public class BpmActTaskAssigneeHistory extends BaseBizEntity {

    private static final long serialVersionUID = -5157343044678198332L;
    /**
     *
     */
    ...
    public Date getFirstCreatedAt() {
        return firstCreatedAt;
    }

    public void setFirstCreatedAt(Date firstCreatedAt) {
