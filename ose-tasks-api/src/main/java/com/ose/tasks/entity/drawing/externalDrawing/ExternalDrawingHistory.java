 ...
 */
@Entity
@Table(name = "external_drawing_history")
public class ExternalDrawingHistory extends BaseBizEntity {

    private static final long serialVersionUID = 380470522528489366L;
    /**
     *
     */
    ...
    public ExternalDrawingHistory(ExternalDrawing drawing){
        this.setCreatedAt();
