 ...
 */
@Entity
@Table(name = "mat_f_material_stocktake_total")
public class FMaterialStocktakeTotalEntity extends BaseEntity {
    ...
    @Transient
    private List<FMaterialStocktakeItemEntity> chlidren;

    @Column(name = "stocktake_qty", precision = 19, scale = 3)
    ...
    public List<FMaterialStocktakeItemEntity> getChlidren() {
        return chlidren;
    }

    public void setChlidren(List<FMaterialStocktakeItemEntity> chlidren) {
