...
@Entity
@Table(name = "performance_appraisal_list_detail")
public class PerformanceAppraisalListDetail extends BaseBizEntity {
    @Schema(description = "绩效考核编号")
    private String performance_appraisal_id;
    ...
    public String getPerformance_appraisal_id() {
        return performance_appraisal_id;
    }

    public void setPerformance_appraisal_id(String performance_appraisal_id) {
        this.performance_appraisal_id = performance_appraisal_id;
    }
