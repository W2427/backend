 ...
 */
@Entity
@Table(name = "structure_process_entity")
public class StructureProcessEntity extends BaseStrEntity {


    private static final long serialVersionUID = 721805221756576408L;
    @Id
    @Column
    private String id;
    ...
    @Schema(description = "所属 ISO 项目节点编号")
    @Column
    private String isoProjectNodeNo;
    ...
    public String getIsoProjectNodeNo() {
        return isoProjectNodeNo;
    }

    public void setIsoProjectNodeNo(String isoProjectNodeNo) {
        this.isoProjectNodeNo = isoProjectNodeNo;
    }
