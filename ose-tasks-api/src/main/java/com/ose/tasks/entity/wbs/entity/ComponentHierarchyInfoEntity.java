...
// 这个是视图
@Entity
@Table(name = "component_hierarchy_info")
public class ComponentHierarchyInfoEntity extends ComponentEntityBase {

    private static final long serialVersionUID = 7659762993299276012L;
    ...
    @JsonCreator
    public ComponentHierarchyInfoEntity() {
        this(null);
    }

    public ComponentHierarchyInfoEntity(Project project) {
        super(project);
