 ...
 */
@MappedSuperclass
public class ISOEntityBase extends WBSEntityBase {
    ...
    @Schema(description = "Bom 节点编码 bom_ln_code")//ftjftj
    @Column(length = 255)
    private String bomLnCode;

    @Schema(description = "Bom 节点材料匹配的百分比 match_percent") //ftjftj
    @Column
    private Float matchPercent;

    @Schema(description = "Bom 节点匹配的更新时间 match_date")//ftjftj
    @Column
    private Date matchDate;

    @Schema(description = "对应Bom 节点 SPM 数据库 ID LN_ID")//ftjftj
    @Column(length = 12)
    private Integer bomLnId;
    ...
    @JsonCreator
    public ISOEntityBase() {
        this(null);
    }

    public ISOEntityBase(Project project) {
        super(project);
        setEntityType("ISO");
    }
    ...
    public String getBomLnCode() {
        return bomLnCode;
    }

    public void setBomLnCode(String bomLnCode) {
        this.bomLnCode = bomLnCode;
    }
    ...
    public Integer getBomLnId() {
        return bomLnId;
    }

    public void setBomLnId(Integer bomLnId) {
        this.bomLnId = bomLnId;
    }
