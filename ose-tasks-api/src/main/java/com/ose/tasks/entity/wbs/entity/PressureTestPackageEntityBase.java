 ...
 */
@Entity
@Table(name = "entity_pressure_test_package",
    indexes = {
        @Index(columnList = "no,projectId,deleted")
    })
public class PressureTestPackageEntityBase extends WBSEntityBase implements WorkflowProcessVariable {
    ...
    @JsonCreator
    public PressureTestPackageEntityBase() {
        this(null);
    }

    public PressureTestPackageEntityBase(Project project) {
        super(project);
        setEntityType("PRESSURE_TEST_PACKAGE");
    }


    @Override
    public String getName() {
        return "PressureTestPackageEntityBase";
    }
