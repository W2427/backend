...
// 这个是视图
@Entity
@Table(name = "spool_hierarchy_info")
public class SpoolHierarchyInfoEntity extends SpoolEntityBase {

    private static final long serialVersionUID = 6129126662488926518L;
    ...
    @JsonCreator
    public SpoolHierarchyInfoEntity() {
        this(null);
    }

    public SpoolHierarchyInfoEntity(Project project) {
        super(project);
