...
/**
 * WP01 Module实体数据实体基类。 WP1 分类 工作包指派用
 */
//这是视图
@Entity
@Table(name = "wp01_task_package")
public class Wp01TaskPackageEntity extends Wp01EntityBase {


    private static final long serialVersionUID = -178672126226966620L;
