...
/**
 * WP03 Panel实体数据实体基类。 WP3 分类
 */
//这是视图
@Entity
@Table(name = "wp03_hierarchy_info")
public class Wp03HierarchyInfoEntity extends Wp03EntityBase {


    private static final long serialVersionUID = 8238811833105043180L;
    ...
    @JsonCreator
    public Wp03HierarchyInfoEntity() {
        this(null);
    }

    public Wp03HierarchyInfoEntity(Project project) {
        super(project);
