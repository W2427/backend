 ...
 */
@MappedSuperclass
public class Wp04EntityBase extends WBSEntityBase {


    private static final long serialVersionUID = 2341303516212182507L;
    ...
    @Schema(description = "部件型号Member Size")
    @Column(length = 255)
    ...
    @JsonCreator
    public Wp04EntityBase() {
        this(null);
    }

    public Wp04EntityBase(Project project) {
        super(project);
        setEntityType("WP04");
    }
    ...
    @JsonSetter
    public void setDwgNo(BpmEntityType bpmEntityType, Project project) {
...
//        String wp01_part = wp01No;
        ...
        String dwgPattern = bpmEntityType.getDwgPattern();
