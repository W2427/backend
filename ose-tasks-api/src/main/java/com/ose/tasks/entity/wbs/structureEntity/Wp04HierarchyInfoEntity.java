...
/**
 * WP04 Structure_component实体数据实体基类。 WP4 分类
 */
//这是视图
@Entity
@Table(name = "wp04_hierarchy_info")
public class Wp04HierarchyInfoEntity extends Wp04EntityBase {


    private static final long serialVersionUID = -1200200083812182051L;
    ...
    @JsonCreator
    public Wp04HierarchyInfoEntity() {
        this(null);
    }

    public Wp04HierarchyInfoEntity(Project project) {
        super(project);
