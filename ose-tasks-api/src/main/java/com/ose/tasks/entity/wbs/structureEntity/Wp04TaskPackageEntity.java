...
/**
 * WP04 Structure_component实体数据实体基类。 WP4 分类 任务包分类
 */
//这是视图
@Entity
@Table(name = "wp04_task_package")
public class Wp04TaskPackageEntity extends Wp04EntityBase {


    private static final long serialVersionUID = 3110843688441800869L;
