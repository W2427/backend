...
/**
 * WP05 Part 实体数据实体基类。 WP5 分类
 */
//这是视图
@Entity
@Table(name = "wp05_hierarchy_info")
public class Wp05HierarchyInfoEntity extends Wp05EntityBase {


    private static final long serialVersionUID = -1341596270414100874L;
    ...
    @JsonCreator
    public Wp05HierarchyInfoEntity() {
        this(null);
    }

    public Wp05HierarchyInfoEntity(Project project) {
        super(project);
