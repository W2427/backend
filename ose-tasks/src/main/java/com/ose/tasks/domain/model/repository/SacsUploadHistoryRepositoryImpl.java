 ...
 *
 */
public class SacsUploadHistoryRepositoryImpl extends BaseRepository implements SacsUploadHistoryRepositoryCustom {
    ...
    public Page<SacsUploadHistory>sacsUploadHistories(Long orgId, Long projectId,
        ...
        sql.append("  his.`memo`, ");
        sql.append("  his.`calculated_file_id` AS calculatedFileId,");
        sql.append("  his.`calculated_file_path` AS calculatedFilePath,");
        sql.append("  his.`calculated_file_name` AS calculatedFileName ");
        sql.append("FROM");
        sql.append("  `sacs_upload_history` his ");
        ...
        List<SacsUploadHistory> resultList = new ArrayList<>();

        for (Map<String, Object> wpsMap : queryResultList) {
            SacsUploadHistory his = new SacsUploadHistory();
