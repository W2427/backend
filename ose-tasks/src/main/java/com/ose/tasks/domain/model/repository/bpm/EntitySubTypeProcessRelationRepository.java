 ...
 */
@Transactional
public interface EntitySubTypeProcessRelationRepository extends PagingAndSortingWithCrudRepository<BpmEntityTypeProcessRelation, Long> {

    @Query("SELECT m.entitySubType FROM BpmEntityTypeProcessRelation m "
        + "WHERE m.process.id = :id and m.projectId = :projectId and m.orgId = :orgId and m.status = 'ACTIVE'")
    List<BpmEntitySubType> findEntitySubTypeByProcessIdAndProjectIdAndOrgId(@Param("id") Long id, @Param("projectId") Long projectId, @Param("orgId") Long orgId);
    ...
    Optional<BpmEntityTypeProcessRelation> findByProcessIdAndEntitySubTypeIdAndStatus(Long processId, Long entitySubTypeId, EntityStatus active);

    List<BpmEntityTypeProcessRelation> findByEntitySubTypeIdAndStatus(Long id, EntityStatus active);

    List<BpmEntityTypeProcessRelation> findByProcessIdAndStatus(Long id, EntityStatus status);

    @Query(
        value = "SELECT m.entitySubType FROM BpmEntityTypeProcessRelation m "
            + "WHERE m.process.id = :id and m.projectId = :projectId and m.orgId = :orgId and m.status = 'ACTIVE'"
    ...
    Page<BpmEntitySubType> findEntitySubTypeByProcessIdAndProjectIdAndOrgIdAndTypeId(@Param("id") Long id, @Param("projectId") Long projectId, @Param("orgId") Long orgId,
    ...
    Page<BpmEntitySubType> findEntitySubTypeByProcessIdAndProjectIdAndOrgIdasPage(@Param("id") Long id, @Param("projectId") Long projectId, @Param("orgId") Long orgId,
                                                                                   Pageable pageable);
