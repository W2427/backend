 ...
 */
@Transactional
public interface DesignChangeReviewRegisterRepositoryCustom {

    Page<DesignChangeReviewRegister> searchDesignChangeReviewRegisterList(Long orgId, Long projectId,
