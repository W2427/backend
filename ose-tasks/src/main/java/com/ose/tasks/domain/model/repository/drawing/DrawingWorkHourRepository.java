 ...
 */
@Transactional
public interface DrawingWorkHourRepository extends PagingAndSortingWithCrudRepository<DrawingWorkHour, Long>, DrawingWorkHourRepositoryCustom {
...
//
//    @Query("SELECT distinct m.drawingCategory FROM Drawing m WHERE m.projectId = :projectId and m.orgId = :orgId and m.status = 'ACTIVE'")
