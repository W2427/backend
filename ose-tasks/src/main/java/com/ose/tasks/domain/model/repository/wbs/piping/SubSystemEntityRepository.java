 ...
 * 清洁包实体 CRUD 操作接口。
 */
public interface SubSystemEntityRepository extends
    WBSEntityBaseRepository<SubSystemEntityBase>,
    WBSEntityCustomRepository<SubSystemEntityBase, WBSEntryCriteriaBaseDTO> {

    List<SubSystemEntityBase> findByProjectIdAndDeletedIsFalse(Long projectId);
