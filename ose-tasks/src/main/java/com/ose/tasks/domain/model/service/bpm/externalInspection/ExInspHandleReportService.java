 ...
 */
@Component
public class ExInspHandleReportService implements ExInspHandleReportInterface {

    private final static Logger logger = LoggerFactory.getLogger(ExInspHandleReportService.class);
     ...
     */
    @Autowired
    public ExInspHandleReportService(
    ...
    public BpmExInspConfirmResponseDTO handleReport(
        ...
        BpmExInspConfirmResponseDTO responseDTO = (BpmExInspConfirmResponseDTO) metaData.get("responseDTO");
