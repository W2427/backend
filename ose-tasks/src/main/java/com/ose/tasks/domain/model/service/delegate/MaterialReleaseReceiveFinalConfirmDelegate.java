...
import com.ose.material.dto.MmReleaseReceiveInventoryStatusDTO;
 ...
 */
@Component
public class MaterialReleaseReceiveFinalConfirmDelegate extends BaseBpmTaskDelegate implements BaseBpmTaskInterfaceDelegate {
     ...
     */
    @Autowired
    public MaterialReleaseReceiveFinalConfirmDelegate(BpmActivityInstanceRepository bpmActInstRepository,
    ...
    public ExecResultDTO preExecute(ContextDTO contextDTO, Map<String, Object> data, ExecResultDTO execResult) {
        ...
        if (mmReleaseReceiveEntity != null && execResult.getTodoTaskDTO() != null && execResult.getTodoTaskDTO().getCommand() != null
            ...
            dto.setRunningStatus(EntityStatus.CANCEL);
