 ...
 */
@Component
public class ArchEqMcItrDelegate extends BaseBpmTaskDelegate implements BaseBpmTaskInterfaceDelegate {
    ...
    private final static Logger logger = LoggerFactory.getLogger(ArchEqMcItrDelegate.class);

    /**
     * 构造方法。
     */
    @Autowired
    public ArchEqMcItrDelegate(BpmActivityInstanceRepository bpmActInstRepository,
