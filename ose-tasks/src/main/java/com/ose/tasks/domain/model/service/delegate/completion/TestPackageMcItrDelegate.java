 ...
 */
@Component
public class TestPackageMcItrDelegate extends BaseBpmTaskDelegate implements BaseBpmTaskInterfaceDelegate {
    ...
    private final static Logger logger = LoggerFactory.getLogger(TestPackageMcItrDelegate.class);

    /**
     * 构造方法。
     */
    @Autowired
    public TestPackageMcItrDelegate(BpmActivityInstanceRepository bpmActInstRepository,
...
//        EitEqEntity eitEq = eitEqEntityRepository.findByProjectIdAndIdAndDeletedIsFalse(projectId, pn.getEntityId());
