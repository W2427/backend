...
@Component
public class EitEqPackageMcItrReport implements McItrReportInterface{
    ...
    {{
        ...
        subTypeMap.put("PAGA_EP", "PAGA PACKAGE");
        subTypeMap.put("SDCN_EP", "TELEPHONE/NETWORK PACKAGE");
        subTypeMap.put("RADIO_EP", "COMMUNICATION PACKAGE");
        subTypeMap.put("FGS_EP", "FIRE DETECTOR PACKAGE");
        subTypeMap.put("LIGHTING_CIRCUIT_EP", "LIGHTING PACKAGE");
        subTypeMap.put("SOCKET_CIRCUIT_EP", "SOCKET PACKAGE");
        subTypeMap.put("ANALOG_TRANSMITTER_EP", "ANALOG INSTRUMENT PACKAGE");
        subTypeMap.put("DIGITAL_TRANSMITTER_EP", "DIGITAL INSTRUMENT PACKAGE");
        subTypeMap.put("LOCAL_GAUGE_EP", "LOCAL GAUGE PACKAGE");
        subTypeMap.put("MISCELLANEOUS_EL_EP", "MISC ELEC PACKAGE");

    }}



    public EitEqPackageMcItrReport(BpmCheckSheetRepository checkSheetRepository,
...
//        entityType = eqPackage == null? null:pn.getEntityType();
//        type = eqPackage.getNo() + " " + subTypeMap.get(eqPackage.getEntitySubType());
        ...
        for (EntityTypeProcessItrTemplateRelation etpitr : etpitrs) {
            if("HULL".equalsIgnoreCase(sector) &&
                (etpitr.getItrTemplateNo().equalsIgnoreCase("I-56A")
                    || etpitr.getItrTemplateNo().equalsIgnoreCase("I-57A"))) {
                continue;
            }
