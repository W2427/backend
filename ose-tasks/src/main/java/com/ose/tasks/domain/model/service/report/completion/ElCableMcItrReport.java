...
@Component
public class ElCableMcItrReport implements McItrReportInterface{
    ...
    public ElCableMcItrReport(BpmCheckSheetRepository checkSheetRepository,
    ...
    public List<ReportHistory> generateReport(Long orgId, Long projectId,
        ...
        if("CABLE_PACKAGE".equals(pn.getEntityType())) {
//            CablePackageEntity cablePackage = cablePackageEntityRepository.findByProjectIdAndIdAndDeletedIsFalse(projectId, pn.getEntityId());
//            entityType = cablePackage == null? null:cablePackage.getEntityType();
//            type = subTypeMap.get(cablePackage.getEntitySubType());
...
//            type = subTypeMap.get(cableEntity.getEntitySubType());
